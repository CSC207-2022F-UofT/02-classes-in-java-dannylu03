...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two parameters as its arguments.
     * @param string1 the first string in this Silly instance's name
     * @param string2 the second string in this Silly instance's name
     */
